...
function handleMovementStates(db: In, player: Player) {
...
function handleOffsetState(db: InitialDataType, player: Player, pos: Vector3, vel: Vector3, rot: Vector3, isonground: boolean) {
